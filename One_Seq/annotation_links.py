...
def ann(dufID, pfamID, c):
    putHitFile = f"../DUFs/{dufID}/{pfamID}_Split_{c}_putative_hits.txt"
    putaAnnoFile = f'../DUFs/{dufID}/{pfamID}_Split_{c}_putative_annotations.txt'
    if c == 0:
        putHitFile = f"../DUFs/{dufID}/{pfamID}_putative_hits.txt"
        putaAnnoFile = f'../DUFs/{dufID}/{pfamID}_putative_annotations.txt'
